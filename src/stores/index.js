    ...
    form: [
      {
        ...
        labelName: 'Firstname :',
        inputType: 'text',
        placeholderName: 'Your firstname',
        required: 'required',
      },
      {
        inputName: 'lastname',
      ...
      },
      {
        ...
        labelName: 'Email :',
        inputType: 'email',
        placeholderName: 'Your Email adress',
        required: 'required',
      },
      {
        inputName: 'tel',
        labelName: 'Your telephone number (Optionnal) :',
        inputType: 'tel',
        placeholderName: 'Your telephone number',
        required: '',
      },
      {
        inputName: 'subject',
        labelName: 'Subject :',
        inputType: 'text',
        placeholderName: 'Your Email subject',
        required: '',
      },
      {
        inputName: 'message',
