...
export const useMobilityStore = defineStore('mobility', {
  state: () => ({
    reportDownload: {
      ...
      url: '@/assets/downloads/Intermobility-White-Paper-2024-Acting-today-for-more-inclusion,diversity-and-equity-in-mobility-and-transportation.pdf',
    },
    slidesCarousel: [
      {
        name: 'Events',
        url: '@/assets/images/engagements/event1.jpg',
        alt: 'Engaged participants at an InterMobility event',
      },
      {
        name: 'Conferences',
        url: '@/assets/images/engagements/conferenceramu1.jpg',
        alt: 'Inspirational speakers at an InterMobility conference',
      },
      {
        name: 'Reports & white papers',
        url: '@/assets/images/engagements/report&whitepapers.png',
    ...
    podcasts: [
      {
        image: '@/assets/images/podcasts/the_citiesfirst_podcast_logo.jpg',
      ...
      {
        image: '@/assets/images/podcasts/MobilityPioneer.png',
    ...
    team: [
      {
        image: '@/assets/images/team/kenneth1.jpg',
        name: 'Kenneth Jensen',
      ...
      {
        image: '@/assets/images/team/lukas1.jpg',
      ...
      {
        image: '@/assets/images/team/ramu1.jpg',
        name: 'Ramu Nair',
      ...
      {
        image: '@/assets/images/team/fh2.jpg',
      ...
      {
        image: '@/assets/images/team/ScottShepard.png',
        name: 'Scott Shepard',
      ...
      {
        image: '@/assets/images/team/dagmara.jpg',
    ...
    supports: [
      {
        image: '@/assets/images/experts/supports/ambassadors.jpg',
      ...
      {
        image: '@/assets/images/experts/supports/femmesenmouvement.png',
        name: ' Femmes en Mouvement',
        url: 'https://www.femvt.fr/',
      },
      {
        image: '@/assets/images/experts/supports/polis.png',
        name: 'Polis Network for Cities & Regions',
        url: 'https://www.polisnetwork.eu/',
      },
      {
        image: '@/assets/images/experts/supports/mobilians.png',
        name: 'Mobilians',
    ...
    articles: [
      {
        ...
        image: '@/assets/images/articles/egalite_des_genres.jpg',
      },
      {
        title: 'Mobility HUB',
        resume:
        ...
        image: '@/assets/images/articles/Hubs_de_mobilité.jpg',
      },
      {
        title: 'USP Network',
        resume:
        ...
        image: '@/assets/images/articles/USP_du_reseau.jpeg',
      },
      {
        ...
        image: '@/assets/images/articles/decarbonation.jpg',
      },
    ],
    books: [
      {
        title: 'Reconstruire le féminisme',
        image: '@/assets/images/articles/Reconstruire-le-feminisme.jpg',
      },
    ],
    modalIsOpen: false,
  }),
