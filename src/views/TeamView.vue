<template>
  <simple-section>
    ...
    <p class="text-lg">
      ...
      united by a passion for innovation in transportation and energy. Our diverse team, ranging
      from policymakers to engineers, embodies excellence in the mobility sector, working towards a
